...
class DeleteReplyForm extends Component {
    ...
    handleSubmit = () => {
        ...
        const requestBody = {reply_id, thread_id, delete_password}
        axios
            .delete('/api/replies', {data: requestBody})
            .then((res) => {
                if (res.data !== 'Success') this.setState({alert: res.data})
                ...
                <Modal isOpen={this.state.modal} toggle={this.toggle}>
                    ...
                    <Form>
                        <ModalBody>
                            ...
                            {this.state.spinner?<Spinner type="grow" color="primary" />:""}
                        </ModalBody>
                        <ModalFooter>
